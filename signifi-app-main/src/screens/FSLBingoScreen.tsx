...
import { View, Text, StyleSheet, Image, Animated, Alert, TouchableOpacity } from 'react-native';
import { NativeStackScreenProps } from '@react-navigation/native-stack';
import { RootStackParamList } from '../../App';
import { FSL_SIGNS, FSLSign } from '../data/FSLSigns';
import { isBingo } from '../utils/bingo';

type Props = NativeStackScreenProps<RootStackParamList, 'FSLBingo'>;
...
export default function FSLBingoScreen({ navigation }: Props) {
    /* ---------- board ---------- */
    ...
    useEffect(() => {
        ...
        Alert.alert('🎉 Bingo!', 'You covered a full line', [
            { text: 'Play again', onPress: () => navigation.replace('FSLBingo') },
        ]);
        ...
        Alert.alert('Game Over', 'No bingo achieved.', [
            { text: 'Try again', onPress: () => navigation.replace('FSLBingo') },
        ]);
        }
    }, [cells]);
